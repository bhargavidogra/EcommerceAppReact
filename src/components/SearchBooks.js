              ...
              <div className="sort-menu dropdown-menu dropdown-menu-right">
                <button
                  className={
                    ...
                    (this.props.orderBy === 'bookName' ? 'active' : '')
                  }
                  onClick={e =>
                    this.props.changeOrder('bookName', this.props.orderDir)
                  }
                  href="#"
                >
                  Book Name
                ...
                <button
                  className={
                    'sort-by dropdown-item ' +
                    (this.props.orderBy === 'authorName' ? 'active' : '')
                  }
                  onClick={e =>
                    this.props.changeOrder('authorName', this.props.orderDir)
                  }
                  href="#"
                >
                  Author
